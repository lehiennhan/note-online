...
export default function TodoCard({ todo, onDelete, onToggleStatus }: TodoCardProps) {
  return (
    <div
      className={`relative p-4 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 bg-opacity-20 border border-opacity-30 flex items-center gap-4 ${
        todo.isCompleted 
